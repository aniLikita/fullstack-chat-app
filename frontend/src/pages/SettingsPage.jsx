...
const PREVIEW_MESSAGES = [
  { id: 1, content: "Hey Shawty wassup?", isSent: false},
  { id: 2, content: "I'm doing aiit, make I paste aza?", isSent: true}
];
          ...
          {THEMES.map((t) => (
            <button
              ...
              className={`
                ...
                rounded-lg transition-colors ${theme === t ?
                ...
                <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                  ...
                  <div className="px-4 py-3 border-b border-base-300 bg-base-300">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-medium text-sm">Ningz</h3>
